...
namespace Accela.Web.SDK
{
    public interface IRecord
    {
        ...
        void UpdateRecordDetail(Record record, string token);
        ...
        // Record Contacts
        List<Contact> GetRecordContacts(string recordId, string token, ref PaginationInfo paginationInfo);
        ...
        void UpdateRecordCustomFields (string recordId, List<Dictionary<string, string>> customFieldList, string token);
